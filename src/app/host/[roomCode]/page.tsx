...
import { supabase, type GameRoom, type Player, type Quiz } from "@/lib/supabase"
...
export default function HostPage() {
  ...
  const startGame = async () => {
    ...
    try {
      ...
      // Fetch questions and choices (randomly select based on question_count)
