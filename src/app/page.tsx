                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <Input
                        ...
                        className="bg-white/10 border-white/20 text-white placeholder:text-gray-500 text-center font-mono h-12 rounded-xl focus:border-white/40 focus:ring-white/20"
                        maxLength={20}
                      />
                    </div>
                  </div>
